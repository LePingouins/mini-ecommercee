    ...
    <div class="container mx-auto px-4">
        ...
        <div class="mb-4">
            <input type="text" id="searchInput" placeholder="Search products..."
                class="w-full md:w-1/3 px-4 py-2 border rounded shadow focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>
        <div class="bg-white bg-opacity-90 p-6 rounded-lg shadow-md">
            ...
            <table class="w-full table-auto border-collapse">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-4 text-center text-gray-700 italic bg-gray-50">No products
                                found.</td>
                        </tr>
                    @endforelse
                </tbody>
